...
#define P_SLEEPING  4                   // sleeping process (extra credit)
#define P_KILL      5                   // kill process (extra credit)
...
struct proc {
    ...
    int sleeping_ticks;                    // tick count for sleeping
    // The first 4 members of `proc` must not change, but you can add more.
};

// Process table
extern proc ptable[PID_MAX];
